...
public final class CommonUtil
{
	...
	{
		return context.getApplication().getDir("data", Context.MODE_PRIVATE);
	}
	...
	public static void loadDataFile(BaseActivity context, final String sourceUrl, final String dataFileName, final long validPeriod)
	{
