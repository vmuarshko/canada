...
public class QuickAppActivity extends SFBaseActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		webview.loadUrl("http://www.mortgagecentreedmonton.com/quick-mortgage-app/");
...
//        		throw new Exception(getString(R.string.error_empty_value));
//        	}
//        	else if (!SFContactsData.EMAIL_ADDRESS_PATTERN.matcher(email).matches())
//        	{
//        		editEmail.requestFocus();
...
//       
//            emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[] { SFContactsData.QUICK_APP_EMAIL });     
